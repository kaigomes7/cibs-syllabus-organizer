...
class ForeignCourseTamuCoursesTest < ApplicationSystemTestCase
  ...
  test 'visiting the index' do
    visit foreign_course_tamu_courses_url
  ...
  test 'creating a Foreign course tamu course' do
    ...
    fill_in 'Foreign course', with: @foreign_course_tamu_course.foreign_course_id
    fill_in 'Tamu course', with: @foreign_course_tamu_course.tamu_course_id
