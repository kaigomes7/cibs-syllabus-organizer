...
class ForeignCoursesStudentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create foreign_courses_student' do
    assert_difference('CoursesStudent.count') do
      post foreign_courses_students_url,
           params: { foreign_courses_student: { foreign_course_id: @foreign_courses_student.foreign_course_id,
                                                student_id: @foreign_courses_student.student_id } }
    end
  ...
  test 'should update foreign_courses_student' do
    patch foreign_courses_student_url(@foreign_courses_student),
          params: { foreign_courses_student: { foreign_course_id: @foreign_courses_student.foreign_course_id,
                                               student_id: @foreign_courses_student.student_id } }
