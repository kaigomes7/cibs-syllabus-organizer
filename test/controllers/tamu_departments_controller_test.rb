...
class TamuDepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tamu_department" do
    assert_difference('TamuDepartment.count') do
      post tamu_departments_url, params: { tamu_department: { tamu_department_name: @tamu_department.tamu_department_name } }
    end
  ...
  test "should update tamu_department" do
    patch tamu_department_url(@tamu_department), params: { tamu_department: { tamu_department_name: @tamu_department.tamu_department_name } }
