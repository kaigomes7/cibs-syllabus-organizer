...
class ForeignCourseTamuCoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create foreign_course_tamu_course' do
    assert_difference('ForeignCourseTamuCourse.count') do
      post foreign_course_tamu_courses_url,
           params: { foreign_course_tamu_course: { foreign_course_id: @foreign_course_tamu_course.foreign_course_id,
                                                   tamu_course_id: @foreign_course_tamu_course.tamu_course_id } }
    end
  ...
  test 'should update foreign_course_tamu_course' do
    patch foreign_course_tamu_course_url(@foreign_course_tamu_course),
          params: { foreign_course_tamu_course: { foreign_course_id: @foreign_course_tamu_course.foreign_course_id,
                                                  tamu_course_id: @foreign_course_tamu_course.tamu_course_id } }
