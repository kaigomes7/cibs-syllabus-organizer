...
class TamuCoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tamu_course" do
    assert_difference('TamuCourse.count') do
      post tamu_courses_url, params: { tamu_course: { course_num: @tamu_course.course_num, tamu_department_id: @tamu_course.tamu_department_id } }
    end
  ...
  test "should update tamu_course" do
    patch tamu_course_url(@tamu_course), params: { tamu_course: { course_num: @tamu_course.course_num, tamu_department_id: @tamu_course.tamu_department_id } }
