...
class ForeignCoursesTamuCoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create foreign_courses_tamu_course' do
    assert_difference('ForeignCourseTamuCourse.count') do
      post foreign_courses_tamu_courses_url,
           params: { foreign_courses_tamu_course: { foreign_course_id: @foreign_courses_tamu_course.foreign_course_id,
                                                    tamu_course_id: @foreign_courses_tamu_course.tamu_course_id } }
    end
  ...
  test 'should update foreign_courses_tamu_course' do
    patch foreign_courses_tamu_course_url(@foreign_courses_tamu_course),
          params: { foreign_courses_tamu_course: { foreign_course_id: @foreign_courses_tamu_course.foreign_course_id,
                                                   tamu_course_id: @foreign_courses_tamu_course.tamu_course_id } }
