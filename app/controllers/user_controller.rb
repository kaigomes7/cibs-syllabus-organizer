...
class UserController < ApplicationController
    ...
    def update
        ...
        if @user.update(user_params)
            ...
            if @user.role == 0 # user is now admin, delete from student and reviewer if exist
            ...
            elsif @user.role == 1 # user is now student, delete from admin and reviewer if exist
